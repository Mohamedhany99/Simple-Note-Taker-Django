...
OPENAI_AZURE_URL = config("OPENAI_AZURE_URL")
OPENAI_AZURE_API_BASE_URL = config("OPENAI_AZURE_API_BASE_URL")
OPENAI_AZURE_ENGINE = config("OPENAI_AZURE_ENGINE")
OPENAI_AZURE_API_VERSION = config("OPENAI_AZURE_API_VERSION")

OPENAI_AZURE_MODEL_NAME = config("OPENAI_AZURE_MODEL_NAME")
OPENAI_AZURE_MAX_TOKENS = config("OPENAI_AZURE_MAX_TOKENS", cast=int)
OPENAI_AZURE_STREAM = config("OPENAI_AZURE_STREAM", cast=bool)

OPENAI_AZURE_EMBEDDINGS_ENGINE = config("OPENAI_AZURE_EMBEDDINGS_ENGINE")
